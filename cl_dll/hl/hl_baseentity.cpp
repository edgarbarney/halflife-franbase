...
// RENDERERS START
const char* CBaseEntity::DamageDecal(int bitsDamageType) { return nullptr; }
// RENDERERS END
...
//RENDERERS START
const char* DamageDecal(CBaseEntity* pEntity, int bitsDamageType, const Vector& vecSrc, const Vector& vecEnd) { return nullptr; }
