...
typedef SpriteHandle_t (*pfnEngSrc_pfnSPR_Load_t)(const char* szPicName);
typedef int (*pfnEngSrc_pfnSPR_Frames_t)(SpriteHandle_t hPic);
typedef int (*pfnEngSrc_pfnSPR_Height_t)(SpriteHandle_t hPic, int frame);
typedef int (*pfnEngSrc_pfnSPR_Width_t)(SpriteHandle_t hPic, int frame);
typedef void (*pfnEngSrc_pfnSPR_Set_t)(SpriteHandle_t hPic, int r, int g, int b);
...
typedef void (*pfnEngSrc_pfnSetCrosshair_t)(SpriteHandle_t hspr, Rect rc, int r, int g, int b);
...
typedef const struct model_s* (*pfnEngSrc_GetSpritePointer_t)(SpriteHandle_t hSprite);
